...
L["Allow MUI to Control Unit Frames"] = "Erlaube MUI die kontrolle über Shadowed Unit Frames";
...
L["Action Bar Panels"] = "Untere Aktionsleisten";
...
L["Show Realm Name"] = "Bereichsnamen anzeigen";
...
L["MayronUI AddOn Presets"] = "MayronUI-AddOn-Voreinstellungen";
L["No Supported AddOns Loaded"] = "Keine unterstützten Add-Ons geladen";
L["The following selected addons will have their settings reset to the MayronUI preset settings:"] = "Die Einstellungen der folgenden ausgewählten Addons werden auf die MayronUI-Voreinstellungen zurückgesetzt:";
L["There is a newer MayronUI preset available for %s."] = "Für %s ist eine neuere MayronUI-Voreinstellung verfügbar.";
L["Would you like to install it?"] = "Möchten Sie es installieren?";
L["Warning! This will wipe all customizations you have made to %s."] = "Warnung! Dadurch werden alle Anpassungen gelöscht, die Sie an %s vorgenommen haben.";
L["Install Preset"] = "Voreinstellung installieren";
L["Skip this Version"] = "Überspringe diese Version";
L["You can always install presets at anytime from the custom install tab located on the MayronUI installer."] = "Sie können Voreinstellungen jederzeit über die Registerkarte „Benutzerdefinierte Installation“ im MayronUI-Installationsprogramm installieren.";
L["Hint: Type %s to access the installer."] = "Tipp: Geben Sie %s ein, um auf das Installationsprogramm zuzugreifen.";
L["Set Arrow Button Visibility"] = "Legen Sie die Sichtbarkeit der Pfeiltasten fest";
L["Hide Arrow Buttons In Combat"] = "Pfeiltasten im Kampf ausblenden";
L["Set Width Mode"] = "Stellen Sie den Breitenmodus ein";
L["If set to dynamic, MayronUI will calculate the optimal width for the selected Bartender4 action bars to fit inside the panel."] = "Wenn dynamisch eingestellt, berechnet MayronUI die optimale Breite für die ausgewählten Bartender4-Aktionsleisten, damit sie in das Bedienfeld passen.";
L["Set Panel Padding"] = "Bereichsfüllung festlegen";
L["Set Height Mode"] = "Höhenmodus einstellen";
L["If set to dynamic, MayronUI will calculate the optimal height for the selected Bartender4 action bars to fit inside the panel."] = "Wenn dynamisch eingestellt, berechnet MayronUI die optimale Höhe für die ausgewählten Bartender4-Aktionsleisten, damit sie in das Bedienfeld passen.";
L["Set the modifier key/s that should be pressed to show the arrow buttons."] = "Stellen Sie die Modifizierertaste(n) ein, die gedrückt werden soll(en), um die Pfeiltasten anzuzeigen.";
L["Set Animation Speed"] = "Animationsgeschwindigkeit einstellen";
L["These settings control the MayronUI artwork behind the Bartender4 action bars."] = "Diese Einstellungen steuern das MayronUI-Artwork hinter den Bartender4-Aktionsleisten.";
L["Background Panel Settings"] = "Hintergrund Panel-Einstellungen";
L["Bottom Panel"] = "Bodenplatte";
L["Action Bars"] = "Aktionsleisten";
L["Popular Settings"] = "Beliebte Einstellungen";
L["Global Settings"] = "Globale Einstellungen";
L["These settings are applied account-wide"] = "Diese Einstellungen gelten für das gesamte Konto";
L["Override Master Font"] = "Master-Schriftart überschreiben";
L["Override Combat Font"] = "Combat Font überschreiben";
L["Combat Font"] = "Combat-Schriftart";
L["This font is used to display the damage and healing combat numbers."] = "Diese Schriftart wird verwendet, um die Schadens- und Heilungskampfzahlen anzuzeigen.";
L["Blizzard Frames"] = "Blizzard-Rahmen";
L["Clamped to Screen"] = "Am Bildschirm festgeklemmt";
L["If checked, Blizzard frames cannot be dragged outside of the screen."] = "Wenn diese Option aktiviert ist, können Blizzard-Frames nicht aus dem Bildschirm gezogen werden.";
L["Reset Positions"] = "Positionen zurücksetzen";
L["Blizzard frame positions have been reset."] = "Blizzard-Frame-Positionen wurden zurückgesetzt.";
L["Set the alpha change while pulsing/flashing."] = "Stellen Sie die Alpha-Änderung während des Pulsens/Blinkens ein.";
L["Dynamic"] = "Dynamisch";
L["Manual"] = "Handbuch";
L["Manual Height Mode Settings"] = "Einstellungen des manuellen Höhenmodus";
L["Set Row 1 Height"] = "Legen Sie die Höhe von Zeile 1 fest";
L["Set Row 2 Height"] = "Stellen Sie die Höhe von Zeile 2 ein";
L["Set Row 3 Height"] = "Stellen Sie die Höhe von Reihe 3 ein";
L["Side Panel"] = "Seitenverkleidung";
L["Set Y-Offset"] = "Y-Offset einstellen";
L["Manual Side Panel Widths"] = "Manuelle Seitenwandbreiten";
L["Set Column 1 Width"] = "Legen Sie die Breite von Spalte 1 fest";
L["Set Column 2 Width"] = "Legen Sie die Breite von Spalte 2 fest";
L["Bartender4 Override Settings"] = "Barkeeper4 Einstellungen außer Kraft setzen";
L["These settings control what MayronUI is allowed to do with the Bartender4 action bars. By default, MayronUI:"] = "Diese Einstellungen steuern, was MayronUI mit den Bartender4-Aktionsleisten tun darf. Standardmäßig MayronUI:";
L["Fades action bars in and out when you press the provided arrow buttons."] = "Blendet Aktionsleisten ein und aus, wenn Sie die bereitgestellten Pfeiltasten drücken.";
L["Maintains the visibility of action bars between sessions of gameplay."] = "Behält die Sichtbarkeit der Aktionsleisten zwischen Spielsitzungen bei.";
L["Sets the scale and padding of action bar buttons to best fit inside the background panels."] = "Stellt die Skalierung und Polsterung der Schaltflächen der Aktionsleiste so ein, dass sie am besten in die Hintergrundfelder passen.";
L["Sets and updates the position the action bars so they remain in place ontop of the background panels."] = "Legt die Position der Aktionsleisten fest und aktualisiert sie, sodass sie auf den Hintergrundfeldern an Ort und Stelle bleiben.";
L["Bottom Bartender4 Action Bars"] = "Unten Bartender4 Aktionsleisten";
L["If enabled, MayronUI will move the selected Bartender4 action bars into the correct position for you."] = "Wenn aktiviert, verschiebt MayronUI die ausgewählten Bartender4-Aktionsleisten für Sie in die richtige Position.";
L["Control Bar Positioning"] = "Positionierung der Steuerleiste";
L["Override Bar Padding"] = "Balkenauffüllung überschreiben";
L["If enabled, MayronUI will set the padding of the selected Bartender4 action bar to best fit the background panel."] = "Wenn aktiviert, stellt MayronUI die Polsterung der ausgewählten Bartender4-Aktionsleiste so ein, dass sie am besten zum Hintergrundfeld passt.";
L["Override Bar Scale"] = "Balkenskala überschreiben";
L["If enabled, MayronUI will set the scale of the selected Bartender4 action bar to best fit the background panel."] = "Wenn aktiviert, stellt MayronUI die Skalierung der ausgewählten Bartender4-Aktionsleiste so ein, dass sie am besten zum Hintergrundpanel passt.";
L["Set Row Spacing"] = "Zeilenabstand festlegen";
L["Set Bar Padding"] = "Stellen Sie die Balkenfüllung ein";
L["Set Bar Scale"] = "Stellen Sie die Balkenskala ein";
L["The bottom panel can display and control up to two Bartender4 action bars per row."] = "Das untere Bedienfeld kann bis zu zwei Bartender4-Aktionsleisten pro Zeile anzeigen und steuern.";
...
L["Positioning and Visibility Options"] = "Positionierungs- und Sichtbarkeitsoptionen";
L["Configure each type of anchor point and tooltip type"] = "Konfigurieren Sie jeden Typ von Ankerpunkt und Tooltip-Typ";
L["Assigning tooltips to the mouse anchor point will fix them to your mouse cursor, causing them to follow your mouse movements."] = "Wenn Sie dem Mausankerpunkt QuickInfos zuweisen, werden sie an Ihrem Mauszeiger fixiert, sodass sie Ihren Mausbewegungen folgen.";
L["Assigning tooltips to the screen anchor point will fix them to that single spot and will not move."] = "Wenn Sie dem Bildschirm-Ankerpunkt QuickInfos zuweisen, werden sie an dieser einzelnen Stelle fixiert und nicht verschoben.";
L["World units are 3D player models within the world and are not part of the UI."] = "Welteinheiten sind 3D-Spielermodelle innerhalb der Welt und nicht Teil der Benutzeroberfläche.";
L["Unit frame tooltips are the UI frames that represent NPCs or players."] = "Unit Frame Tooltips sind die UI-Frames, die NPCs oder Spieler darstellen.";
L["Standard tooltips are any other tooltip with no special category (i.e., inventory item and spell tooltips have their own unique category and will not be affected)."] = "Standard-Tooltips sind alle anderen Tooltips ohne spezielle Kategorie (d. h. Tooltips für Inventargegenstände und Zaubersprüche haben ihre eigene einzigartige Kategorie und sind nicht betroffen).";
L["Unit Frame Tooltips"] = "Tooltips für Einheitenrahmen";
L["World Unit Tooltips"] = "Tooltips der Welteinheiten";
L["Standard Tooltips"] = "Standard-Tooltips";
L["Choose an Anchor Point:"] = "Wählen Sie einen Ankerpunkt:";
L["Visibility Options:"] = "Sichtbarkeitsoptionen:";
L["Set Shown"] = "Satz angezeigt";
L["If unchecked, tooltips of this type will never show"] = "Wenn diese Option deaktiviert ist, werden Tooltips dieses Typs niemals angezeigt";
L["If unchecked, tooltips of this type will not show while you are in combat."] = "Wenn diese Option deaktiviert ist, werden Tooltips dieses Typs nicht angezeigt, während Sie sich im Kampf befinden.";
L["Hide in Combat"] = "Im Kampf verstecken";
L["Mouse"] = "Maus";
L["Screen"] = "Bildschirm";
L["Mouse Anchor Point"] = "Maus-Ankerpunkt";
L["Screen Anchor Point"] = "Bildschirm-Ankerpunkt";
L["Export Profile"] = "Profil exportieren";
L["Export the current profile into a string that can be imported by other players."] = "Exportieren Sie das aktuelle Profil in eine Zeichenfolge, die von anderen Spielern importiert werden kann.";
L["Copy the import string below and give it to other players so they can import your current profile."] = "Kopieren Sie den Import-String unten und geben Sie ihn an andere Spieler weiter, damit sie Ihr aktuelles Profil importieren können.";
L["Close"] = "Nah dran";
L["Import Profile"] = "Importprofil";
L["Import a profile from another player from an import string."] = "Importieren Sie ein Profil von einem anderen Spieler aus einer Importzeichenfolge.";
L["Paste an import string into the box below to import a profile."] = "Fügen Sie eine Importzeichenfolge in das Feld unten ein, um ein Profil zu importieren.";
L["Warning: This will completely replace your current profile with the imported profile settings!"] = "Achtung: Dadurch wird Ihr aktuelles Profil vollständig durch die importierten Profileinstellungen ersetzt!";
L["Successfully imported profile settings into your current profile!"] = "Profileinstellungen erfolgreich in Ihr aktuelles Profil importiert!";
L["Reset to default"] = "Auf Standard zurücksetzen";
L["Appearance Settings"] = "Darstellungseinstellungen";
L["MUI_FRAMES_COLOR_TOOLTIP"] = "Steuert die Hintergrundfarbe von MUI-Rahmen, einschließlich Inventarrahmen, Tooltips, Konfigurationsmenü, Layout-Tool und mehr.";
L["Set Display Mode"] = "Stellen Sie den Anzeigemodus ein";
L["These settings relate to the individual aura icons/bars."] = "Diese Einstellungen beziehen sich auf die einzelnen Aura-Symbole/-Balken.";
L["These settings relate to the frame containing the individual aura icons/bars."] = "Diese Einstellungen beziehen sich auf den Rahmen, der die einzelnen Aura-Symbole/-Balken enthält.";
L["Set Non-Player Alpha"] = "Nicht-Spieler-Alpha festlegen";
L["Icon Width"] = "Symbolbreite";
L["Icon Height"] = "Symbolhöhe";
L["If true, when the aura is close to expiring the aura frame will fade in and out."] = "Wenn dies der Fall ist, wird der Aurarahmen ein- und ausgeblendet, wenn die Aura kurz vor dem Ablauf steht.";
L["The alpha of auras not applied by you."] = "Das Alpha von Auren, die Sie nicht angewendet haben.";
L["Icon Spacing"] = "Symbolabstand";
L["Show Bar Spark"] = "Bar Spark anzeigen";
L["Container Frame Settings"] = "Container-Frame-Einstellungen";
L["Positioning"] = "Positionierung";
L["Rows and Columns"] = "Reihen und Spalten";
L["The maximum number of aura icons to display per row."] = "Die maximale Anzahl der Aura-Symbole, die pro Zeile angezeigt werden sollen.";
L["The maximum number of horizontal bar columns to display."] = "Die maximale Anzahl der anzuzeigenden horizontalen Balkenspalten.";
L["Text Settings"] = "Texteinstellungen";
L["Aura Frame"] = "Aura-Rahmen";
L["Icon Frame"] = "Symbolrahmen";
L["Icon"] = "Symbol";
L["Normal Font Size"] = "Normale Schriftgröße";
L["Warning Font Size"] = "Schriftgröße der Warnung";
L["Warning Threshold"] = "Warnschwelle";
L["The minimum number of seconds remaining required for the time remaining text to use the warning font size."] = "Die verbleibende Mindestanzahl an Sekunden, damit der verbleibende Text die Warnschriftgröße verwenden kann.";
L["Text Colors"] = "Textfarben";
L["Aura Type Colors"] = "Aura-Typ-Farben";
L["Basic Buff"] = "Grundlegender Buff";
L["Player Owned Buff"] = "Spielereigener Buff";
L["Buffs that you applied to yourself."] = "Buffs, die Sie auf sich selbst angewendet haben.";
L["Basic Debuff"] = "Grundlegender Debuff";
L["Bar Colors"] = "Balkenfarben";
L["Borders"] = "Grenzen";
L["Enable Inventory Frame"] = "Inventarrahmen aktivieren";
L["Use the MayronUI custom inventory frame instead of the default Blizzard bags UI."] = "Verwenden Sie den benutzerdefinierten Inventarrahmen von MayronUI anstelle der Standard-Benutzeroberfläche für Blizzard-Taschen.";
L["Use Class Colors"] = "Verwenden Sie Klassenfarben";
L["If checked, tooltips for other players will be colored based on their class."] = "Wenn diese Option aktiviert ist, werden Tooltips für andere Spieler entsprechend ihrer Klasse farbig dargestellt.";
L["Switch to Detailed View"] = "Wechseln Sie zur Detailansicht";
L["Switch to Grid View"] = "Wechseln Sie zur Rasteransicht";
L["View Character Inventory"] = "Charakterinventar anzeigen";
L["Toggle Bags Bar"] = "Taschenleiste umschalten";
L["Quest Items"] = "Questgegenstände";
L["Trade Goods"] = "Handelswaren";
L["Consumables"] = "Verbrauchsmaterial";
L["Equipment"] = "Ausrüstung";
L["All Items"] = "Alle Elemente";

L["Padding"] = "Polsterung";
L["Slot Height"] = "Schlitzhöhe";
L["Max Slot Width"] = "Maximale Schlitzbreite";
L["Min Slot Width"] = "Min. Schlitzbreite";
L["If checked, item levels will show on top of the icons of equipment and weapon items."] = "Wenn diese Option aktiviert ist, werden die Gegenstandsstufen über den Symbolen der Ausrüstungs- und Waffengegenstände angezeigt.";
L["The maximum number of icons that can appear per row when resizing the inventory frame using the grid view."] = "Die maximale Anzahl von Symbolen, die pro Zeile angezeigt werden können, wenn die Größe des Inventarrahmens mithilfe der Rasteransicht geändert wird.";
L["Max Icons Per Row"] = "Maximale Anzahl an Symbolen pro Zeile";
L["Show Quest Items Tab"] = "Registerkarte „Questgegenstände“ anzeigen";
L["Show Trade Goods Tab"] = "Registerkarte „Handelswaren“ anzeigen";
L["Show Consumables Tab"] = "Registerkarte „Verbrauchsmaterialien“ anzeigen";
L["Show Equipment Tab"] = "Registerkarte „Ausrüstung“ anzeigen";
L["Show Tab Buttons"] = "Tab-Schaltflächen anzeigen";
L["Tab Button Options"] = "Tab-Button-Optionen";
L["MUI Frames Color"] = "MUI-Rahmenfarbe";
L["Theme Color"] = "Themenfarbe";
L["Class Color"] = "Klassenfarbe";
L["Color Scheme"] = "Farbschema";
L["Font Options"] = "Schriftartoptionen";
L["Show Item Name"] = "Artikelnamen anzeigen";
L["Item Name Font Size"] = "Schriftgröße des Elementnamens";
L["If checked, item levels will be shown in description of equipment and weapon items."] = "Wenn diese Option aktiviert ist, werden die Gegenstandsstufen in der Beschreibung von Ausrüstungs- und Waffengegenständen angezeigt.";
L["Show Item Type"] = "Artikeltyp anzeigen";
L["Item Description Font Size"] = "Element Beschreibung Schriftgröße";
...
L["You have new messages!"] = "Sie haben neue Nachrichten!";
L["Clear Chat Messages"] = "Chat-Nachrichten löschen";